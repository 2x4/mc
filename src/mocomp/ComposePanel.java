...
public class ComposePanel extends JPanel {
     ...
     * @return 部位コードがpartCodeであるスコアパネルが見つかったら， そのスコアパネル，見つからなかったらnull
     */
    ...
    class TimeScale extends JPanel {
        ...
        private final Font f = new Font("TimesRoman", Font.PLAIN, 9);
        private final FontMetrics fm = getFontMetrics(f);
